...
class SideBar(models.Model):
    ...
    def content_html(self):
        ...
        if self.display_type == self.DISPLAY_HTML:
            ...
            result = render_to_string('themes/default/config/blocks/sidebar_posts.html', context)
            ...
            result = render_to_string('themes/default/config/blocks/sidebar_comments.html', context)
